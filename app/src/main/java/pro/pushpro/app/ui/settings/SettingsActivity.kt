...
import pro.pushpro.app.R; import pro.pushpro.app.ui.access.AccessActivity; import pro.pushpro.app.ui.logs.LogViewerActivity; import pro.pushpro.app.ui.queue.OfflineQueueActivity
class SettingsActivity: AppCompatActivity(){ override fun onCreate(savedInstanceState: Bundle?){ super.onCreate(savedInstanceState); setContentView(R.layout.activity_settings_menu)
